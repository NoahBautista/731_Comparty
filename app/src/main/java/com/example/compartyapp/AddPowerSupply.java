...
public class AddPowerSupply extends AppCompatActivity {
    ...
    public static final String EXTRA_TYPEP =
            "com.example.entityrelationtest.EXTRA_TYPEP";
    ...
    public static final String EXTRA_RATING =
            "com.example.entityrelationtest.EXTRA_RATING";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_power_supply);
        ...
        editType = findViewById(R.id.edit_text_typePower);
        editCapacity = findViewById(R.id.edit_text_capacityPower);
        editRating = findViewById(R.id.edit_text_rating);
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_close);
        setTitle("Add Power Supply");
    ...
    private void savePowerSupply() {
        ...
        String typePower = editType.getText().toString();
        String capacityPower = editCapacity.getText().toString();
        String rating = editRating.getText().toString();

        if (name.trim().isEmpty() || description.trim().isEmpty() || manufacturer.trim().isEmpty() || link.trim().isEmpty() || price == null || productType.trim().isEmpty() || typePower.trim().isEmpty()|| capacityPower.trim().isEmpty()|| rating.trim().isEmpty()) {
        ...
        data.putExtra(EXTRA_TYPEP, typePower);
        data.putExtra(EXTRA_CAPACITY, capacityPower);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.add_powersupply_menu, menu);
        return true;
    }
